...
- `docs/LOOP_RECUPERACAO_TARIEL_WEB.md` é a memória operacional principal desta árvore local.
- `docs/LOOP_ORGANIZACAO_FULLSTACK.md` permanece apenas como histórico legado e não deve guiar novos ciclos aqui.
