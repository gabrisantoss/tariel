...
function criarInput() {
  return {
    ...
    actionsState: {
      ...
      handleSelecionarEstiloResposta: jest.fn(),
      handleSelecionarIdiomaResposta: jest.fn(),
    ...
    draftState: {
      ...
      estiloResposta: "padrão" as const,
      idiomaResposta: "Português" as const,
      ...
      retencaoDados: "90 dias" as const,
    ...
    settersState: {
      onSetAutoUploadAttachments: jest.fn(),
