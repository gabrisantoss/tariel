...
- Loop operacional desta cópia recuperada: `docs/LOOP_RECUPERACAO_TARIEL_WEB.md`
...
- `docs/LOOP_ORGANIZACAO_FULLSTACK.md` fica preservado apenas como histórico legado e não deve ser usado como memória operacional principal desta árvore local.
