...
|---|---|---|---|---|
| `nome_arquivo_pdf`, preview ou materialização de trabalho | PDF operacional | Arquivo de trabalho do caso, útil para conferência interna, sem valor de emissão oficial. | Chat Inspetor, Mobile, Portal Cliente Documentos, preparação de emissão. | PDF oficial, documento emitido, pacote oficial. |
| `EmissaoOficialLaudo.issue_state=issued` | Emissão oficial | Documento emitido pelo motor oficial, vinculado a snapshot aprovado, signatário, hash e auditoria. | Portal Cliente, Mesa, Chat Inspetor, Mobile quando houver emissão ativa. | Rascunho, preview, PDF operacional. |
| Pacote ZIP/hash gerado pela emissão oficial | Pacote oficial | Conjunto congelado de artefatos oficiais, manifesto, hashes e metadados auditáveis. | Download principal, auditoria, Portal Cliente Documentos. | Pacote Mesa, anexos operacionais. |
...
| Self-review governado sem Mesa | Revisão interna governada | Finalização humana interna permitida por pacote/família, sem Mesa separada. | Chat/Mobile, Portal Cliente pacote/recursos. | mobile_autonomous, autonomia mobile. |
| Revisão por revisor separado | Mesa Avaliadora | Módulo de governança contratado ou exigido pela família. | Handoff, fila, aprovação, bloqueios de família. | Reviewer, reviewer_decision, reviewer_issue. |
| Faltas de evidência, correção ou decisão | Pendências do caso | Itens que bloqueiam avanço operacional ou emissão. | Chat, Mobile, Mesa, Portal Cliente status. | Blockers, missing_evidence cru. |
...
| Família de alto risco exige Mesa | Família exige Mesa | A família não pode finalizar por self-review no pacote atual. | Chat/Mobile, Portal Cliente, bloqueio NR35/alto risco. | nr35_mesa_required_unavailable cru. |
...
| Em revisão interna | Self-review humano governado em andamento. | Azul/operacional |
| Na Mesa | Caso está com Mesa Avaliadora. | Índigo/governança |
