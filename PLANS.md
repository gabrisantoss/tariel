...
- `status`: em andamento localmente em `2026-04-26`; PR B adiciona aliases/read model neutros para revisao, aprovacao, emissao e download sem remover capabilities antigas; PR C expõe esse read model na previa de finalizacao e na rail de ferramentas do Chat Inspetor; PR D leva os aliases/sinais para o Mobile como labels e estados de governanca, sem criar emissao oficial nova no app e sem alterar release gate, mobile smoke, Maestro, `human_ack`, NR35 ou comportamento de emissao oficial
