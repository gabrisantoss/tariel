...
- `próximo slice sugerido`: continuar no `mobile` com `Histórico` e `Finalizar`, aproximando `retomada rápida`, `owner atual` e `rota sugerida` do caso canônico em cards de leitura ainda mais direta
