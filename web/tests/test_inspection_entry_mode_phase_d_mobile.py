...
def test_chat_guiado_vincula_evidencia_ao_bundle_do_caso_e_registra_mesa(
    ...
    assert "lotes de fotos do mesmo caso como conjunto integrado" in prompt_capturado["mensagem"]
    assert "imagens-chave para ilustrar o laudo/PDF" in prompt_capturado["mensagem"]
