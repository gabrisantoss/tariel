...
_CAPABILITY_DENIAL_DETAILS: dict[str, str] = {
    ...
    "inspector_send_to_mesa": "O envio para a Revisão Técnica está desabilitado para esta empresa pelo Admin-CEO.",
    "mobile_case_approve": "A aprovação final no mobile está desabilitada para esta empresa pelo Admin-CEO.",
    "reviewer_decision": "A revisão da Revisão Técnica está desabilitada para esta empresa pelo Admin-CEO.",
