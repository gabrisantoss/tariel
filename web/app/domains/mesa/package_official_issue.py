...
def _build_current_issue(payload: dict[str, Any]) -> EmissaoOficialAtualPacoteMesa | None:
    ...
    return EmissaoOficialAtualPacoteMesa(
        ...
        download_url=_resumir_texto_curto(current_issue_payload.get("download_url"), limite=400),
        download_label=_resumir_texto_curto(current_issue_payload.get("download_label"), limite=120),
        download_mime_type=_resumir_texto_curto(current_issue_payload.get("download_mime_type"), limite=120),
