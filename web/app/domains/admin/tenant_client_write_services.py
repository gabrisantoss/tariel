...
def _normalizar_politica_admin_cliente_empresa(
    *,
    ...
    operating_model: str = "",
    tenant_portal_cliente_enabled: str | bool = "",
    tenant_portal_inspetor_enabled: str | bool = "",
    tenant_portal_revisor_enabled: str | bool = "",
    tenant_capability_admin_manage_team_enabled: str | bool = "",
    tenant_capability_inspector_case_create_enabled: str | bool = "",
    tenant_capability_inspector_case_finalize_enabled: str | bool = "",
    tenant_capability_inspector_send_to_mesa_enabled: str | bool = "",
    tenant_capability_mobile_case_approve_enabled: str | bool = "",
    tenant_capability_reviewer_decision_enabled: str | bool = "",
    tenant_capability_reviewer_issue_enabled: str | bool = "",
