        ...
        historico.append(
            {
                ...
                "approval_snapshot_id": int(item.get("approval_snapshot_id") or 0) or None,
                "approval_version": int(item.get("approval_version") or 0) or None,
                "reissue_of_issue_number": str(item.get("reissue_of_issue_number") or "").strip() or None,
                "reissue_reason_codes": list(item.get("reissue_reason_codes") or []),
                "reissue_reason_summary": str(item.get("reissue_reason_summary") or "").strip() or None,
                "superseded_by_issue_number": str(item.get("superseded_by_issue_number") or "").strip() or None,
                "superseded_reason_codes": list(item.get("superseded_reason_codes") or []),
                "superseded_reason_summary": str(item.get("superseded_reason_summary") or "").strip() or None,
                "template_version": nr35_manifest.get("template_version"),
                "schema_version": nr35_manifest.get("schema_version"),
                "nr35_manifest_ok": bool(nr35_manifest.get("manifest_ok")),
